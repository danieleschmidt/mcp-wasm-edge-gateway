...
use mcp_common::{Result, Error, MCPRequest, ComponentHealth, Config};
use std::sync::Arc;
...
pub async fn create_security_manager(config: Arc<Config>) -> Result<Arc<dyn SecurityManager + Send + Sync>> {
